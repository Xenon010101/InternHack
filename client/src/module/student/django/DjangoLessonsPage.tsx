...
export default function DjangoLessonsPage() {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        title="Learn Django, Free Interactive Tutorials"
        ...
        structuredData={[
          courseSchema({
            name: "Learn Django, Free Interactive Tutorials",
            description:
              "Master Django with interactive lessons covering models, views, templates, ORM, REST framework, and interview preparation.",
            url: `${SITE_URL}/learn/django`,
          }),
          breadcrumbSchema([
