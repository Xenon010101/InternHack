...
export default function BlockchainLessonsPage() {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        title="Learn Blockchain, Free Interactive Tutorials"
        description="Master blockchain with interactive lessons covering smart contracts, Solidity, DApps, DeFi, and interview preparation."
        keywords="learn blockchain, blockchain tutorial, blockchain lessons, smart contracts, solidity, DApps"
        canonicalUrl={canonicalUrl("/learn/blockchain")}
        structuredData={[
          courseSchema({
            name: "Learn Blockchain, Free Interactive Tutorials",
            description:
              "Master blockchain with interactive lessons covering smart contracts, Solidity, DApps, DeFi, and interview preparation.",
            url: `${SITE_URL}/learn/blockchain`,
          }),
          breadcrumbSchema([
            { name: "Home", url: SITE_URL },
            { name: "Learn", url: `${SITE_URL}/learn` },
            { name: "Blockchain", url: `${SITE_URL}/learn/blockchain` },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive blockchain lessons, curated for interviews. Smart contracts, Solidity, DApps, and DeFi.
              </p>
            </div>
