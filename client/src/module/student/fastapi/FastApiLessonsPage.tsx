...
export default function FastApiLessonsPage() {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        title="Learn FastAPI, Free Interactive Tutorials"
        ...
        structuredData={[
          courseSchema({
            name: "Learn FastAPI, Free Interactive Tutorials",
            description:
              "Master FastAPI with interactive lessons covering async endpoints, Pydantic models, dependency injection, and interview preparation.",
            url: `${SITE_URL}/learn/fastapi`,
          }),
          breadcrumbSchema([
            { name: "Home", url: SITE_URL },
            { name: "Learn", url: `${SITE_URL}/learn` },
            { name: "FastAPI", url: `${SITE_URL}/learn/fastapi` },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-stone-900 dark:text-stone-50 mb-1.5">
                Ship high-performance APIs.
              </h1>
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive FastAPI lessons, curated for interviews. Async endpoints, Pydantic, dependencies, deployment.
              </p>
            </div>
