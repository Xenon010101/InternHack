...
export default function CssLessonsPage() {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          courseSchema({
            name: "Learn CSS, Free Interactive Tutorials",
            description:
              "Master CSS with interactive lessons covering Flexbox, Grid, animations, responsive design, and interview preparation.",
            url: `${SITE_URL}/learn/css`,
          }),
          breadcrumbSchema([
            { name: "Home", url: SITE_URL },
            { name: "Learn", url: `${SITE_URL}/learn` },
            { name: "CSS", url: `${SITE_URL}/learn/css` },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive CSS lessons, curated for interviews. Box model, flexbox, grid, animations, and responsive design.
              </p>
            </div>
