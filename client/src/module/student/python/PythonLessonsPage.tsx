...
export default function PythonLessonsPage() {
  ...
  // Preload Pyodide when the user lands on this page
  useEffect(() => {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          courseSchema({
            name: "Learn Python, Free Interactive Tutorials",
            description:
              "Master Python with interactive lessons covering variables, functions, OOP, data structures, and interview preparation.",
            url: `${SITE_URL}/learn/python`,
          }),
          breadcrumbSchema([
