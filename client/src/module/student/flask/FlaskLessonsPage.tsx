...
export default function FlaskLessonsPage() {
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        title="Learn Flask, Free Interactive Tutorials"
        ...
        structuredData={[
          courseSchema({
            name: "Learn Flask, Free Interactive Tutorials",
            description:
              "Master Flask with interactive lessons covering routes, templates, REST APIs, blueprints, and interview preparation.",
            url: `${SITE_URL}/learn/flask`,
          }),
          breadcrumbSchema([
