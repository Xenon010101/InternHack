  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          courseSchema({
            name: "Learn React, Free Interactive Tutorials",
            description:
              "Master React with interactive lessons covering components, hooks, state management, routing, and interview preparation.",
            url: `${SITE_URL}/learn/react`,
          }),
          breadcrumbSchema([
            { name: "Home", url: SITE_URL },
            { name: "Learn", url: `${SITE_URL}/learn` },
            { name: "React", url: `${SITE_URL}/learn/react` },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive React lessons, curated for interviews. Components, hooks, state, and routing.
              </p>
            </div>
